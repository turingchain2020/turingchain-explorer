...
export default {
  ...
  computed: {
    ...
    logo(){
      return this.$store.getters.getStyle==='white'? require('../../assets/images/jiejing.png'):require('../../assets/images/jiejing-b.png')
    }
  },
  methods: {
...
<style lang="scss">
  .head .head-content img[data-v-5989d702] {
    height: 50px;
    margin-top: 12px;
    float: left;
    cursor: pointer;
  ...
  .head .head-content ul li[data-v-5989d702] {
    min-width: 80px;
    display: inline-block;
    margin-left: 10px;
    font-size: 16px;
